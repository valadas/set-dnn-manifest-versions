...
const globOptionsHelper = __nccwpck_require__(164);
const path = __nccwpck_require__(928);
const patternHelper = __nccwpck_require__(891);
...
const assert = __nccwpck_require__(613);
const path = __nccwpck_require__(928);
const pathHelper = __nccwpck_require__(138);
const IS_WINDOWS = process.platform === 'win32';
/**
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    globPattern = "**/*.dnn";
                    fileStream = (0, fs_1.createReadStream)(skipFile);
                ...
                case 23:
                    ...
                    files_2.forEach(function (file) {
                        var packageJsonContent = (0, fs_1.readFileSync)(file).toString();
                        ...
                        (0, fs_1.writeFile)(file, newFileContent, function (err) {
                            if (err) {
                                core.setFailed(err.message);
                            }
                            else {
